...
import { peopleAndAnimalsShop } from "../../dataShop"

import styles from './styles/shopAnimals.module.scss'

const linkPeopleAndAnimals: string = 'https://disk.yandex.ru/d/a7CJ9FA93iy7OA'
const _apiUrl = 'https://cloud-api.yandex.net/v1/disk/public/resources?public_key='
const urlPeopleAndAnimalsShop = `${_apiUrl}${linkPeopleAndAnimals}&limit=100`
...
export default ShopPeopleAndAnimals