...
export const dataWorksFlowers: TypesDataWorks[] = [
  ...
  { category: 'flowers', name: 'delicateHydrangea', source: delicateHydrangeaImg, class: '', id: 4 },
  { category: 'flowers', name: 'delicateRose', source: delicateRoseImg, class: '', id: 5 },
  { category: 'flowers', name: 'delicateScentOfPeonies', source: delicateScentOfPeoniesImg, class: '', id: 6 },
  { category: 'flowers', name: 'delicateTulips', source: delicateTulipsImg, class: '', id: 7 },
  { category: 'flowers', name: 'eveningFlowers', source: eveningFlowersImg, class: '', id: 8 },
  { category: 'flowers', name: 'flowersForBeloved', source: flowersForBelovedImg, class: '', id: 9 },
  { category: 'flowers', name: 'flowersMood', source: flowersMoodImg, class: '', id: 10 },
  { category: 'flowers', name: 'hydrangea', source: hydrangeaImg, class: '', id: 11 },
  { category: 'flowers', name: 'irises', source: irisesImg, class: '', id: 12 },
  { category: 'flowers', name: 'largePeonies', source: largePeoniesImg, class: '', id: 13 },
  { category: 'flowers', name: 'luxuriousPeonies', source: luxuriousPeoniesImg, class: '', id: 14 },
  { category: 'flowers', name: 'narcissists', source: narcissistsImg, class: '', id: 15 },
  { category: 'flowers', name: 'peonyFestival', source: peonyFestivalImg, class: '', id: 16 },
  { category: 'flowers', name: 'pinkBlooming', source: pinkBloomingImg, class: '', id: 17 },
  ...
  { category: 'flowers', name: 'roseInGarden', source: roseInGardenImg, class: '', id: 21 },
